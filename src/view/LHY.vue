...
export default {
  ...
  mounted() {
    ...
    // function initVars(){
      ...
      var pow1=new Audio(s+"pow1.ogg");
      var pow2=new Audio(s+"pow2.ogg");
      var pow3=new Audio(s+"pow3.ogg");
      var pow4=new Audio(s+"pow4.ogg");
      var frames = 0;
    // }
  ...
  function splode(x,y,z){
    ...
    switch(type){
      case 0:
        var pic1=parseInt(Math.random()*10);
        break;
      case 1:
        pic1=parseInt(Math.random()*10);
        do{ var pic2=parseInt(Math.random()*10); }while(pic2==pic1);
        break;
      case 2:
        pic1=parseInt(Math.random()*10);
        do{ pic2=parseInt(Math.random()*10); }while(pic2==pic1);
        do{ var pic3=parseInt(Math.random()*10); }while(pic3==pic1 || pic3==pic2);
        break;
    }
    for(let m=1;m<t;++m){
    ...
    let d=Math.sqrt((x-playerX)*(x-playerX)+(y-playerY)*(y-playerY)+(z-playerZ)*(z-playerZ));
